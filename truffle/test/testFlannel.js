...
contract('Flannel', accounts => {
  ...
  context('Flannel - Threshold Functions', () => {
    ...
    // [7] = Eth Top-Up
    let defTestSet = ["Default", 20, 60, 20, web3.utils.toWei('5', 'ether'), web3.utils.toWei('1', 'ether'), web3.utils.toWei('3', 'ether'), web3.utils.toWei('5', 'ether')];
    let newTestSet = ["Test Set", 40, 40, 20, web3.utils.toWei('10', 'ether'), web3.utils.toWei('2', 'finney'), web3.utils.toWei('5', 'ether'), web3.utils.toWei('5', 'ether')];
    let badTestSet = ["Test Set", 40, 50, 20, web3.utils.toWei('10', 'ether'), web3.utils.toWei('2', 'finney'), web3.utils.toWei('3', 'ether'), web3.utils.toWei('5', 'ether')];
  ...
  context('Flannel - Function Co-ordinator', () => {
    ...
    it('Tops up the node correctly', async () => {
      let params = ["Default", 20, 60, 20, web3.utils.toWei('5', 'ether'), web3.utils.toWei('1', 'ether'), web3.utils.toWei('3', 'ether'), web3.utils.toWei('15', 'ether')];
      await flannel.createNewAllowance(params[0], params[1], params[2], params[3], params[4], params[5], params[6], params[7], { from: owner });
